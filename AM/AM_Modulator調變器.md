...
$V_1 (t)=A_c cos(2\pi f_c t)+m(t)$ → $V_2(t)\sim [Acos(2\pi f_c t)+m(t)]g\_{T_0} (t)$ </br>
...
$V_2(t)\sim \frac{1}{2}Acos(2\pi f_c t)+\frac{1}{2}m(t)+\frac{A}{\pi}\sum_{n=1}^{\infty}\frac{(-1)^{n-1}}{2n-1}[cos(2\pi f_c.2nt)+cos(2\pi f_c(2n-2)t)]+\frac{2}{\pi}\sum_{n=1}^{\infty}\frac{(-1)^{n-1}}{2n-1}m(t)cos[2\pi f_c (2n-1)t]$ </br>
